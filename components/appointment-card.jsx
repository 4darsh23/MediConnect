        ...
        <CardContent className="p-4">
          <div className="flex flex-col md:flex-row justify-between gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-medium text-white">{userRole === "DOCTOR" ? otherParty.name : `Dr. ${otherParty.name}`}</h3>
      ...
      >
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>{appointment.status === "SCHEDULED" ? "Manage your upcoming appointment" : "View appointment information"}</DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              {userRole === "DOCTOR" && action === "notes" ? (
                ...
                <div className="p-3 rounded-md bg-muted/20 border border-emerald-900/20 min-h-[80px]">{appointment.notes ? <p className="text-white whitespace-pre-line">{appointment.notes}</p> : <p className="text-muted-foreground italic">No notes added yet</p>}</div>
              )}
            </div>
          </div>
