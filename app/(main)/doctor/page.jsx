...
import { AvailabilitySettings } from "./_components/availaibility-settings";
...
export default async function DoctorDashboardPage() {
  ...
  const [appointmentsData, availabilityData, earningsData, payoutsData] = await Promise.all([getDoctorAppointments(), getDoctorAvailability(), getDoctorEarnings(), getDoctorPayouts()]);
